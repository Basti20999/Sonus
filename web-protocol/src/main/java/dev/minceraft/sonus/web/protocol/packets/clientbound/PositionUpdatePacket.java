...
public class PositionUpdatePacket extends WebSocketPacket {
    ...
    private @MonotonicNonNull RotatedVec3d position;

    public PositionUpdatePacket(RotatedVec3d position) {
    ...
    public void encode(ByteBuf buf, WsPacketContext context) {
        RotatedVec3d.encode(buf, this.position);
    }

    @Override
    public void decode(ByteBuf buf, WsPacketContext context) {
        this.position = RotatedVec3d.decode(buf);
    }
    ...
    public void setPosition(RotatedVec3d position) {
        this.position = position;
    }
}
