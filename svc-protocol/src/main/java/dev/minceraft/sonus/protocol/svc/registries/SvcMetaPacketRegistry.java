...
import dev.minceraft.sonus.protocol.svc.meta.AddCategorySvcPacket;
import dev.minceraft.sonus.protocol.svc.meta.AddGroupSvcPacket;
import dev.minceraft.sonus.protocol.svc.meta.CreateGroupSvcPacket;
import dev.minceraft.sonus.protocol.svc.meta.JoinedGroupSvcPacket;
import dev.minceraft.sonus.protocol.svc.meta.LeaveGroupSvcPacket;
import dev.minceraft.sonus.protocol.svc.meta.PlayerStateSvcPacket;
import dev.minceraft.sonus.protocol.svc.meta.RemoveCategorySvcPacket;
import dev.minceraft.sonus.protocol.svc.meta.RemoveGroupSvcPacket;
import dev.minceraft.sonus.protocol.svc.meta.RequestSecretSvcPacket;
import dev.minceraft.sonus.protocol.svc.meta.SecretSvcPacket;
import dev.minceraft.sonus.protocol.svc.meta.SvcMetaPacket;
import dev.minceraft.sonus.protocol.svc.meta.UpdateStateSvcPacket;
